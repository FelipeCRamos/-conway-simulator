...
RM = -rm
OBJS = $(addprefix $(objdir)/,cell.o generation.o canvas.o sha256.o io.o)

# Phony targets
.PHONY: clean cleanobj cleanbin cleansym
.PHONY: all run main build cell generation canvas sha256 io
...
build: cell sha256 generation canvas io
